...
from model import data, train_arima, test_arima, forecasts_arima
...
tab_content = [
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    dcc.Graph(figure=show_forecast_test_plot(data, train_arima, forecasts_arima, test_arima, 'ARIMA'), id='arima_pred')
                ], width={'size': 6})
        ]),
]
